...
from pygyro.splines.mod_spline_eval_funcs import eval_spline_2d_cross, eval_spline_2d_scalar, eval_spline_1d_scalar, eval_spline_1d_vector
...
spline_context.insert_function(eval_spline_1d_scalar, ['double','double[:]','int','double[:]','int'])
spline_context.insert_function(eval_spline_1d_vector, ['double','double[:]','int','double[:]','double[:]','int'])
