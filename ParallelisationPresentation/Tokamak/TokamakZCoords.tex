...
\def\outerRadius{2}
    ...
    \addplot3[domain=0:0.53, line width=0.5mm, mark=none, color=black, samples y=0]
         ({(\outerRadius+\innerRadius)*cos(deg(x))}, 
	  {(\outerRadius+\innerRadius)*sin(deg(x))}, 
	  {0});
    
    \addplot3[domain=2.6:pi, line width=0.5mm, mark=none, color=black, samples y=0]
         ({(\outerRadius+\innerRadius)*cos(deg(x))}, 
	  {(\outerRadius+\innerRadius)*sin(deg(x))}, 
	  {0});
    
    \addplot3[domain=0:0.9, line width=0.5mm, mark=none, color=black, samples y=0]
         ({(\outerRadius+\innerRadius*cos(deg(pi/5)))*cos(deg(x))}, 
	  {(\outerRadius+\innerRadius*cos(deg(pi/5)))*sin(deg(x))}, 
	  {\innerRadius*sin(deg(pi/5))});
    
    \addplot3[domain=2.8:pi, line width=0.5mm, mark=none, color=black, samples y=0]
         ({(\outerRadius+\innerRadius*cos(deg(pi/5)))*cos(deg(x))}, 
	  {(\outerRadius+\innerRadius*cos(deg(pi/5)))*sin(deg(x))}, 
	  {\innerRadius*sin(deg(pi/5))});
    ...
    \addplot3[domain=2.4:pi, line width=0.5mm, mark=none, color=black, samples y=0]
    ...
    \addplot3[domain=0:1.35, line width=0.5mm, mark=none, color=black, samples y=0]
         ({(\outerRadius+\innerRadius*cos(deg(pi*1.4)))*cos(deg(x))}, 
	  {(\outerRadius+\innerRadius*cos(deg(pi*1.4)))*sin(deg(x))}, 
	  {\innerRadius*sin(deg(pi*1.4))});
    
    \addplot3[domain=0:1.53, line width=0.5mm, mark=none, color=black, samples y=0]
         ({(\outerRadius+\innerRadius*cos(deg(pi*1.6)))*cos(deg(x))}, 
	  {(\outerRadius+\innerRadius*cos(deg(pi*1.6)))*sin(deg(x))}, 
	  {\innerRadius*sin(deg(pi*1.6))});
    ...
    \addplot3[domain=0:2*pi, line width=0.5mm, mark=none, color=red, samples y=0]
         ({(\outerRadius+\innerRadius*cos(deg(x)))}, 
	  {0}, 
	  {\innerRadius*sin(deg(x))});
    ...
    \addplot3[domain=0.6:pi*1.15, line width=0.5mm, mark=none, color=red, samples y=0]
         ({(\outerRadius+\innerRadius*cos(deg(x)))*cos(deg(pi/3))}, 
	  {(\outerRadius+\innerRadius*cos(deg(x)))*sin(deg(pi/3))}, 
	  {\innerRadius*sin(deg(x))});
    
    \addplot3[domain=0.7:pi*1.3, line width=0.5mm, mark=none, color=red, samples y=0]
