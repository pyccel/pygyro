...
def test_fluxAdvectionAligned():
    ...
    for i in range(nconvpts):
        ...
        #~ print(np.min((f_vals-final_f_vals)**2),np.max((f_vals-final_f_vals)**2))
        
        #~ print(np.min(trapz((f_vals-final_f_vals)**2,eta_vals[1],axis=0)),np.max(trapz((f_vals-final_f_vals)**2,eta_vals[1],axis=0)))
        #~ print(trapz((f_vals-final_f_vals)**2,eta_vals[1],axis=0))
        
        #~ print(trapz(trapz((f_vals-final_f_vals)**2,eta_vals[1],axis=0),eta_vals[2]))
        #~ print(eta_vals[2])
