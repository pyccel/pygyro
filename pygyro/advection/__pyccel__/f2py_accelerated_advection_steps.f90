...
subroutine poloidal_advection_step_expl(n0_f, n1_f, f, dt, v, n0_rPts, &
  ...
  real(kind=8), intent(inout) :: f(0:n1_f-1,0:n0_f-1)
  ...
  real(kind=8), intent(in) :: coeffsPhi(0:n1_coeffsPhi-1,0: &
      n0_coeffsPhi-1)
  integer(kind=8), intent(in) :: deg1Phi
  integer(kind=8), intent(in) :: deg2Phi
  ...
  real(kind=8), intent(in) :: coeffsPol(0:n1_coeffsPol-1,0: &
      n0_coeffsPol-1)
  integer(kind=8), intent(in) :: deg1Pol
  integer(kind=8), intent(in) :: deg2Pol
  ...
  !f2py integer(kind=8) :: n0_f=shape(f,0)
  !f2py integer(kind=8) :: n1_f=shape(f,1)
  !f2py intent(c) f
  !f2py integer(kind=8) :: n0_drPhi_0=shape(drPhi_0,0)
  !f2py integer(kind=8) :: n1_drPhi_0=shape(drPhi_0,1)
  !f2py intent(c) drPhi_0
  !f2py integer(kind=8) :: n0_dthetaPhi_0=shape(dthetaPhi_0,0)
  !f2py integer(kind=8) :: n1_dthetaPhi_0=shape(dthetaPhi_0,1)
  !f2py intent(c) dthetaPhi_0
  !f2py integer(kind=8) :: n0_drPhi_k=shape(drPhi_k,0)
  !f2py integer(kind=8) :: n1_drPhi_k=shape(drPhi_k,1)
  !f2py intent(c) drPhi_k
  !f2py integer(kind=8) :: n0_dthetaPhi_k=shape(dthetaPhi_k,0)
  !f2py integer(kind=8) :: n1_dthetaPhi_k=shape(dthetaPhi_k,1)
  !f2py intent(c) dthetaPhi_k
  !f2py integer(kind=8) :: n0_endPts_k1_q=shape(endPts_k1_q,0)
  !f2py integer(kind=8) :: n1_endPts_k1_q=shape(endPts_k1_q,1)
  !f2py intent(c) endPts_k1_q
  !f2py integer(kind=8) :: n0_endPts_k1_r=shape(endPts_k1_r,0)
  !f2py integer(kind=8) :: n1_endPts_k1_r=shape(endPts_k1_r,1)
  !f2py intent(c) endPts_k1_r
  !f2py integer(kind=8) :: n0_endPts_k2_q=shape(endPts_k2_q,0)
  !f2py integer(kind=8) :: n1_endPts_k2_q=shape(endPts_k2_q,1)
  !f2py intent(c) endPts_k2_q
  !f2py integer(kind=8) :: n0_endPts_k2_r=shape(endPts_k2_r,0)
  !f2py integer(kind=8) :: n1_endPts_k2_r=shape(endPts_k2_r,1)
  !f2py intent(c) endPts_k2_r
  !f2py integer(kind=8) :: n0_coeffsPhi=shape(coeffsPhi,0)
  !f2py integer(kind=8) :: n1_coeffsPhi=shape(coeffsPhi,1)
  !f2py intent(c) coeffsPhi
  !f2py integer(kind=8) :: n0_coeffsPol=shape(coeffsPol,0)
  !f2py integer(kind=8) :: n1_coeffsPol=shape(coeffsPol,1)
  !f2py intent(c) coeffsPol
  !f2py bool :: nulBound = False
  call mod_poloidal_advection_step_expl(f, dt, v, rPts, qPts, nPts, &
...
subroutine v_parallel_advection_eval_step(n0_f, f, n0_vPts, vPts, rPos, &
  ...
  real(kind=8), intent(in) :: kTi
  real(kind=8), intent(in) :: deltaRTi
  integer(kind=8), intent(in) :: bound

  call mod_v_parallel_advection_eval_step(f, vPts, rPos, vMin, vMax, kts &
      , deg, coeffs, CN0, kN0, deltaRN0, rp, CTi, kTi, deltaRTi, bound)
...
subroutine get_lagrange_vals(i, nz, n0_shifts, shifts, n0_vals, n1_vals, &
  ...
  integer(kind=8), intent(in) :: shifts(0:n0_shifts-1)
  integer(kind=4), intent(in) :: n0_vals
  integer(kind=4), intent(in) :: n1_vals
  integer(kind=4), intent(in) :: n2_vals
  real(kind=8), intent(inout) :: vals(0:n2_vals-1,0:n1_vals-1,0: &
      n0_vals-1)
  ...
  !f2py integer(kind=8) :: n0_vals=shape(vals,0)
  !f2py integer(kind=8) :: n1_vals=shape(vals,1)
  !f2py integer(kind=8) :: n2_vals=shape(vals,2)
  !f2py intent(c) vals
  call mod_get_lagrange_vals(i, nz, shifts, vals, qVals, thetaShifts, &
      kts, deg, coeffs)
...
subroutine flux_advection(nq, nr, n0_f, n1_f, f, n0_coeffs, coeffs, &
  ...
  integer(kind=4), intent(in) :: n1_vals
  integer(kind=4), intent(in) :: n2_vals
  real(kind=8), intent(in) :: vals(0:n2_vals-1,0:n1_vals-1,0:n0_vals-1)
...
subroutine poloidal_advection_step_impl(n0_f, n1_f, f, dt, v, n0_rPts, &
  ...
  !f2py intent(c) coeffsPol
  !f2py bool :: nulBound = False
  call mod_poloidal_advection_step_impl(f, dt, v, rPts, qPts, nPts, &
      drPhi_0, dthetaPhi_0, drPhi_k, dthetaPhi_k, endPts_k1_q, &
      endPts_k1_r, endPts_k2_q, endPts_k2_r, kts1Phi, kts2Phi, &
      coeffsPhi, deg1Phi, deg2Phi, kts1Pol, kts2Pol, coeffsPol, deg1Pol &
