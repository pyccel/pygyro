...
def test_OddLayoutPaths():
    ...
    compare_f(eta_grids[0], eta_grids[1],
              eta_grids[2], eta_grids[3], layout, f)
...
def test_CompatibleLayouts():
    ...
    nprocs = compute_2d_process_grid(
        [10, 10, 10, 10], MPI.COMM_WORLD.Get_size())
...
def test_LayoutSwapper():
    ...
    LayoutSwapper(comm, [layouts1, layouts2], [
                  nprocs, nprocs[0]], eta_grids, 'flux_surface2')
