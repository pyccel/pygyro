...
#==============================================================================
#$ header function find_span(double[:],int,double) results(int)
...
#==============================================================================
#$ header function basis_funs(double[:],int,double,int,double[:])
...
#$ header function basis_funs_1st_der(double[:],int,double,int,double[:])
