...
pure subroutine eval_spline_1d_scalar( x, n0_knots, knots, degree, n0_coeffs, &
      coeffs, der, y )
...
!==============================================================================
pure subroutine eval_spline_1d_vector( n0_x, x, n0_knots, knots, degree, &
...
!==============================================================================
pure subroutine eval_spline_2d_scalar( x, y, n0_kts1, kts1, deg1, n0_kts2, &
...
!==============================================================================
pure subroutine eval_spline_2d_cross(n0_xVec, xVec, n0_yVec, yVec, n0_kts1, &
