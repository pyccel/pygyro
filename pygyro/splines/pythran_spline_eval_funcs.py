...
def eval_spline_2d_vector(x,y,kts1,deg1,kts2,deg2,coeffs,z,der1=0,der2=0):
    if (der1==0 and der2==0):
        eval_spline_2d_vector_00(x,y,kts1,deg1,kts2,deg2,coeffs,z,der1,der2)
    elif (der1==0 and der2==1):
        eval_spline_2d_vector_01(x,y,kts1,deg1,kts2,deg2,coeffs,z,der1,der2)
    elif (der1==1 and der2==0):
        eval_spline_2d_vector_10(x,y,kts1,deg1,kts2,deg2,coeffs,z,der1,der2)
    elif (der1==1 and der2==1):
        eval_spline_2d_vector_11(x,y,kts1,deg1,kts2,deg2,coeffs,z,der1,der2)
