...
#phi_hh = np.multiply(phi,r_scaling_inv) * 1/(4*dr*dphi)
...
Jpp_phi = assemble_Jpp(phi, N0_nodes0, N0_nodes1, grid1)
Jpx_phi = -assemble_Jpx(phi, N0_nodes0, N0_nodes1, grid1)
Jxp_phi = -assemble_Jxp(phi, N0_nodes0, N0_nodes1, grid1)

#Jpp_phi = np.multiply(Jpp_phi,r_scaling_inv)* 1/(4*dr*dphi)
#Jpx_phi = np.multiply(Jpx_phi,r_scaling_inv)* 1/(4*dr*dphi)
#Jxp_phi = np.multiply(Jxp_phi,r_scaling_inv)* 1/(4*dr*dphi)


Jpp_phi = Jpp_phi* 1/(4*dr*dphi)
Jpx_phi = Jpx_phi* 1/(4*dr*dphi)
Jxp_phi = Jxp_phi* 1/(4*dr*dphi)
