...
The result should therefore be the following:\todo{Check with Yaman. Convergence works but isn't this the wrong (not cylindrical coordinates) definition of the gradient?}
\begin{equation}
